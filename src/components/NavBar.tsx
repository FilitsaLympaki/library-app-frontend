                   ...
                   <div className="flex items-center justify-between h-16">
                       ...
                       <div className="flex items-center space-x-4">
                           ...
                           <div className="hidden md:flex items-center space-x-1">
                               <Button onClick={handleClick} variant="ghost" className="text-slate-700 hover:bg-white/50">
                                   Home
                               </Button>
                           </div>
                       </div>
                       ...
                       <div className="hidden md:flex items-center space-x-4">
                           ...
                           <DropdownMenu>
                               <DropdownMenuTrigger asChild>
                                   <Button variant="outline" className="bg-white border-slate-300 hover:bg-slate-50 px-3">
                   ...
                   <div className="md:hidden bg-white border-t border-slate-200">
                       <div className="px-4 py-2 space-y-2">
                           ...
                           <div className="border-t border-slate-200 pt-2">
                               ...
                               <Button onClick={handleSignOut} variant="ghost" className="w-full justify-start text-red-600 pl-6">
                                   Sign Out
                               </Button>
                           </div>
                       </div>
